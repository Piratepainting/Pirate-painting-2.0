          ...
          <div className="flex h-14 sm:h-16 md:h-18 lg:h-20 items-center justify-between">
            ...
            <div className="hidden md:flex items-center gap-2 lg:gap-4">
              <Link href="/contact#quote-form">
                <AnimatedButton
                  className="bg-purple-600 hover:bg-purple-700 text-white font-medium text-sm sm:text-base h-9 sm:h-10 transition-all duration-300 shadow-md hover:shadow-lg"
                  hoverEffect="lift"
                  iconAnimation={true}
                >
                  Get a Quote
                ...
                >
                  ...
                  >
                    <AnimatePresence mode="wait">
                      ...
                      >
                        {theme === "dark" ? (
                          <Sun className="h-3.5 w-3.5 sm:h-4 sm:w-4 text-purple-500" />
                        ) : (
            ...
            <div className="flex items-center gap-1.5 sm:gap-2 md:hidden">
                ...
                >
                  ...
                  >
                    <AnimatePresence mode="wait">
                      ...
                      >
                        {theme === "dark" ? (
                          <Sun className="h-4 w-4 sm:h-5 sm:w-5 text-purple-500" />
                        ) : (
              ...
              <Button
                variant="ghost"
                size="icon"
                className="h-8 w-8 sm:h-9 sm:w-9 bg-purple-50 dark:bg-purple-900/20"
                onClick={toggleMobileMenu}
                aria-expanded={mobileMenuOpen}
                aria-label="Toggle menu"
                type="button"
              >
                <Menu className="h-4 w-4 sm:h-5 sm:w-5 text-purple-600 dark:text-purple-400" />
              </Button>
            </div>
          </div>
        </div>
...
function NavItem({
  ...
  return (
    <li>
      <Link
        href={href}
        className={`relative px-2 sm:px-3 py-1.5 sm:py-2 rounded-md text-sm sm:text-base font-medium transition-colors flex items-center focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 ${
          isActive
            ? "text-purple-500 dark:text-purple-400"
            : "text-foreground hover:text-purple-500 hover:bg-purple-50/50 dark:hover:bg-purple-900/10"
        }`}
        onMouseEnter={onHover}
        onMouseLeave={onLeave}
      >
        <motion.span
          animate={isHovered && !isActive ? { y: -2, color: "#A855F7" } : { y: 0 }}
              ...
              <Link
                ...
                className={`block cursor-pointer text-sm sm:text-base py-1.5 sm:py-2 px-2.5 sm:px-3 rounded-lg ${
                  pathname === item.href
                    ...
                    : "hover:text-purple-500 hover:bg-purple-50/50 dark:hover:bg-purple-900/10"
                }`}
