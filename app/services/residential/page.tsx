...
export const metadata = {
  title: "Residential Construction | Pirate Painting Construction",
  description:
    "Explore Pirate Painting's residential construction services including custom homes, renovations, and additions.",
}
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center max-w-6xl mx-auto">
            <div>
              ...
              <p className="text-gray-700 mb-6 text-lg">
                At Pirate Painting, we understand that your home is more than just a building—it's where memories are
                made and lives are lived. That's why we approach each residential project with care, precision, and a
                    ...
                    <div className="md:w-1/2 relative">
                      <div className="bg-gray-50 p-8 rounded-2xl shadow-sm relative z-10">
                        <div className="bg-purple-100 w-12 h-12 rounded-full flex items-center justify-center mb-4">
                          <span className="text-purple-700 font-bold text-xl">{index + 1}</span>
                        </div>
        ...
        <div className="container mx-auto px-4">
                ...
                <div className="relative h-80 w-full">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end">
                    <div className="p-6 w-full">
                      ...
                      <p className="text-purple-300 mb-4">{project.location}</p>
          ...
          <div className="text-center mt-12">
            <Link href="/projects">
              <Button
                variant="outline"
                className="border-purple-500 text-purple-500 hover:bg-purple-500 hover:text-white font-medium px-8 bg-transparent"
              >
                View All Projects
                <ArrowRight className="ml-2 h-4 w-4" />
              </Button>
            ...
            {testimonials.map((testimonial, index) => (
              <div key={index} className="bg-gray-50 p-8 rounded-2xl shadow-sm hover:shadow-md transition-shadow">
                <div className="flex items-center mb-6">
                  <div className="relative h-16 w-16 rounded-full overflow-hidden mr-4 border-2 border-purple-300">
                    <Image
                  ...
                  <div>
                    ...
                    <p className="text-purple-600">{testimonial.project}</p>
                  </div>
                </div>
      ...
      <section className="py-20 bg-gray-900 text-white">
        <div className="container mx-auto px-4 text-center max-w-4xl">
          ...
          <p className="text-gray-300 text-lg max-w-2xl mx-auto mb-10">
            Contact us today for a free consultation and discover how Pirate Painting can bring your residential vision
            to life.
          </p>
...
const testimonials = [
  {
    ...
    quote:
      "Pirate Painting turned our dream home into reality. Their attention to detail and commitment to quality exceeded our expectations. We couldn't be happier with our new home.",
